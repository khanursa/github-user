...
import com.reston.githubuser.consumergithubuser.view.MainActivity
...
class AlarmReciver : BroadcastReceiver() {
    companion object {
        const val EXTRA_MESSAGE = "consumer"
        private const val ID_REPEATING = 101
        private const val TIME_FORMAT = "HH:mm"
        private const val TIME = "09:00"
        private const val MESSAGE =
            "Alarm Consumer Github user\nPengingat alarm untuk kembali lagi ke aplikasi Consumer"
    }
    ...
    private fun showAlarmNotification(
        ...
        val builder = NotificationCompat.Builder(context, chanelId)
            ...
            .setContentTitle("Alarm Consumer Github-User")
    ...
    fun setRepeatingAlarm(context: Context) {
        ...
        Toast.makeText(context, "Repeating alarm di aktifkan ke jam $TIME", Toast.LENGTH_SHORT)
            .show()
    }
